/**
 * 处理类别：
 * 返回string/json，string/json转换为其他对象；
 * 使用getStringFromXX来得到string；
...
tingfengF.prototype.stringUtilsF=function(){
		...
		{  var isNullString=(typeof string=="undefined"||string==null);
			...
			if(true==isAutoConvertion&&isNullString)
		    	{
		    		return '';
		    	}
		    else if(!isAutoConvertion&&isNullString){
		    	return string;
		    }
		...
		*/
		self2.getNumberByString=function(srcStr,isAutoConvertion){
				...
				var value =srcStr.replace(/[^0-9.]/ig,"");
      ...
      self2.isMobileNumber=function(mobile)
		...
		self2.getHtmlString=function(string){
			if(tingfeng.stringUtils.isEmpty(string))
				return "";
			var tmpData=string;
			tmpData=tmpData.replace(/</g,"&lt");
			tmpData=tmpData.replace(/>/g,"&gt");
			tmpData=tmpData.replace(/\"/g,"&quot");
